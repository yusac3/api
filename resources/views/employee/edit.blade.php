                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                @if ($employee->encrypted_filename)
                                    <small class="form-text text-muted">Current CV:
                                        {{ $employee->original_filename }}</small>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="delete_cv" id="delete_cv">
                                        <label class="form-check-label" for="delete_cv">
                                            Delete current CV
                                        </label>
                                    </div>
                                @endif
